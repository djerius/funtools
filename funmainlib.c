...
void *
funtoolsMainLibInit( void ) {
    MainLib ml;
    if ( !( ml = MainLibNew(  ) ) )
	return NULL;
    if ( !MainLibAdd
         ( ml, "funtools", "funcalc", funcalc_main, MAINLIB_ARGV ) )
	return NULL;
    if ( !MainLibAdd( ml, "funtools", "funcen", funcen_main, MAINLIB_ARGV ) )
	return NULL;
    if ( !MainLibAdd
         ( ml, "funtools", "funcnts", funcnts_main, MAINLIB_ARGV ) )
	return NULL;
    if ( !MainLibAdd
         ( ml, "funtools", "funcone", funcone_main, MAINLIB_ARGV ) )
	return NULL;
    if ( !MainLibAdd
         ( ml, "funtools", "fundisp", fundisp_main, MAINLIB_ARGV ) )
	return NULL;
    if ( !MainLibAdd
         ( ml, "funtools", "funhead", funhead_main, MAINLIB_ARGV ) )
	return NULL;
    if ( !MainLibAdd
         ( ml, "funtools", "funhist", funhist_main, MAINLIB_ARGV ) )
	return NULL;
    if ( !MainLibAdd
         ( ml, "funtools", "funimage", funimage_main, MAINLIB_ARGV ) )
	return NULL;
    if ( !MainLibAdd
         ( ml, "funtools", "funjoin", funjoin_main, MAINLIB_ARGV ) )
	return NULL;
    if ( !MainLibAdd
         ( ml, "funtools", "funmerge", funmerge_main, MAINLIB_ARGV ) )
	return NULL;
    if ( !MainLibAdd( ml, "funtools", "funsky", funsky_main, MAINLIB_ARGV ) )
	return NULL;
    if ( !MainLibAdd
         ( ml, "funtools", "funtable", funtable_main, MAINLIB_ARGV ) )
	return NULL;
    return ml;
}
