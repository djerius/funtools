...
int funcalc_main _PRx(
        ( int argc,
          char **argv )
 );
int funcen_main _PRx(
        ( int argc,
          char **argv )
 );
int funcnts_main _PRx(
        ( int argc,
          char **argv )
 );
int funcone_main _PRx(
        ( int argc,
          char **argv )
 );
int fundisp_main _PRx(
        ( int argc,
          char **argv )
 );
int funhead_main _PRx(
        ( int argc,
          char **argv )
 );
int funhist_main _PRx(
        ( int argc,
          char **argv )
 );
int funimage_main _PRx(
        ( int argc,
          char **argv )
 );
int funjoin_main _PRx(
        ( int argc,
          char **argv )
 );
int funmerge_main _PRx(
        ( int argc,
          char **argv )
 );
int funsky_main _PRx(
        ( int argc,
          char **argv )
 );
int funtable_main _PRx(
        ( int argc,
          char **argv )
 );
