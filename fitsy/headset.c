 ...
 */
FITSCard
ft_headsetl( fits, name, n, lvalue, comm, append )
     ...
     int append;                /* Append the card if not found         */
{
    ...
    if ( !
         ( card =
           ft_cardsetl( ft_headfind( fits, name, n, 1 ), lvalue, comm ) )
&& append )
 ...
 */
FITSCard
ft_headseti( fits, name, n, ivalue, comm, append )
     FITSHead fits;
     char *name;
     int n;
     ...
     int append;
{
    ...
    if ( !
         ( card =
           ft_cardseti( ft_headfind( fits, name, n, 1 ), ivalue, comm ) )
&& append )
 ...
 */
FITSCard
ft_headsetil( fits, name, n, ivalue, comm, append )
     FITSHead fits;
     char *name;
     int n;
     ...
     int append;
{
    ...
    if ( !
         ( card =
           ft_cardsetil( ft_headfind( fits, name, n, 1 ), ivalue, comm ) )
&& append )
 ...
 */
FITSCard
ft_headsetr( fits, name, n, rvalue, prec, comm, append )
     FITSHead fits;
     char *name;
     int n;
 ...
 */
FITSCard
ft_headsets( fits, name, n, svalue, comm, append )
     FITSHead fits;
     char *name;
     int n;
     ...
     int append;
{
    ...
    if ( !
         ( card =
           ft_cardsets( ft_headfind( fits, name, n, 1 ), svalue, comm ) )
&& append )
