 ...
 */
FITSCard
ft_headinsl( fits, name, n, lvalue, comm, here )
     ...
     FITSCard here;             /* Insert the new card after this card. */
{
    ...
    return ft_cardins( fits,
                       ft_cardfmt( &card, name, n, FT_LOGICAL, &lvalue, 0,
                                   comm )
                       , here );
}
 ...
 */
FITSCard
ft_headinsi( fits, name, n, ivalue, comm, here )
     FITSHead fits;
     char *name;
     int n;
     ...
     FITSCard here;
{
    ...
    return ft_cardins( fits,
                       ft_cardfmt( &card, name, n, FT_INTEGER, &ivalue, 0,
                                   comm )
                       , here );
}
 ...
 */
FITSCard
ft_headinsil( fits, name, n, ivalue, comm, here )
     FITSHead fits;
     char *name;
     int n;
 ...
 */
FITSCard
ft_headinsr( fits, name, n, dvalue, prec, comm, here )
     FITSHead fits;
     char *name;
     int n;
     ...
     FITSCard here;
{
    ...
    return ft_cardins( fits,
                       ft_cardfmt( &card, name, n, FT_REAL, &dvalue, prec,
                                   comm )
                       , here );
}
 ...
 */
FITSCard
ft_headinss( fits, name, n, svalue, comm, here )
     FITSHead fits;
     char *name;
     int n;
     ...
     FITSCard here;
{
    ...
    return ft_cardins( fits,
                       ft_cardfmt( &card, name, n, FT_STRING, svalue, 0,
                                   comm )
                       , here );
}
 ...
 */
FITSCard
ft_headinsv( fits, name, n, vvalue, comm, here )
     FITSHead fits;
     char *name;
     int n;
 ...
 */
FITSCard
ft_headappl( fits, name, n, lvalue, comm )
     FITSHead fits;
     char *name;
     int n;
     int lvalue;
 ...
 */
FITSCard
ft_headappi( fits, name, n, ivalue, comm )
     FITSHead fits;
     char *name;
     int n;
     int ivalue;
 ...
 */
FITSCard
ft_headappil( fits, name, n, ivalue, comm )
     FITSHead fits;
     char *name;
     int n;
     longlong ivalue;
 ...
 */
FITSCard
ft_headappr( fits, name, n, dvalue, prec, comm )
     FITSHead fits;
     char *name;
     int n;
     double dvalue;
 ...
 */
FITSCard
ft_headapps( fits, name, n, svalue, comm )
     FITSHead fits;
     char *name;
     int n;
     char *svalue;
 ...
 */
FITSCard
ft_headappv( fits, name, n, vvalue, comm )
     FITSHead fits;
     char *name;
     int n;
     char *vvalue;
