...
ft_headinsl(
    ...
    return ft_cardins( fits, ft_cardfmt( &card, name, n, FT_LOGICAL, &lvalue, 0, comm )
                       , here );
}
...
ft_headinsi(
    ...
    return ft_cardins( fits, ft_cardfmt( &card, name, n, FT_INTEGER, &ivalue, 0, comm )
                       , here );
}
...
ft_headinsil(
    ...
    return ft_cardins( fits, ft_cardfmt( &card, name, n, FT_LONG, &ivalue, 0, comm )
                       , here );
}
...
ft_headinsr(
    ...
    return ft_cardins( fits, ft_cardfmt( &card, name, n, FT_REAL, &dvalue, prec, comm )
                       , here );
}
...
ft_headinss(
    ...
    return ft_cardins( fits, ft_cardfmt( &card, name, n, FT_STRING, svalue, 0, comm )
                       , here );
}
...
ft_headinsv(
    ...
    return ft_cardins( fits, ft_cardfmt( &card, name, n, FT_VALUE, vvalue, 0, comm )
                       , here );
}
